        ...
        <div className="text-center mb-8">
          ...
          <div className="flex items-center justify-center gap-6 mb-4">
            ...
            <div className="text-left">
              <span className="text-lg md:text-xl text-gray-400 block">
                Hi, I&apos;m
              </span>
          ...
          <p className="text-base sm:text-lg md:text-xl text-gray-400 leading-relaxed text-center px-4">
            Crafting exceptional mobile experiences with
            <span className="text-blue-400"> Dart</span>,{" "}
            <span className="text-purple-400"> Kotlin</span>, and
          ...
          <div className="group bg-gradient-to-b from-gray-800/50 to-gray-900/50 rounded-xl sm:rounded-2xl p-1 max-w-2xl mx-auto mt-4">
            <div className="bg-gradient-to-b from-gray-900 to-gray-800 rounded-xl sm:rounded-2xl overflow-hidden p-4 sm:p-6">
              ...
              <p className="text-base sm:text-lg md:text-xl text-gray-400 leading-relaxed text-left mt-4">
                I&apos;m currently learning Flutter and Dart to expand my mobile
                development expertise. I also have experience in Shopify website
                development. When I&apos;m not coding, I explore new tech trends
                or work on personal projects to stay sharp. I&apos;m excited to
                connect and contribute my skills to innovative projects!
              </p>
            </div>
          </div>
        </div>
